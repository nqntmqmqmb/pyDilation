...
def Shift(time_space, details):
    ...
    if details == 0:
        ...
        if shift < 3600:
            return "If a chronometer was present on the surface of your object, there will be a shift of {0} seconds in one year between the latter and a distant observer".format(str(shift))

        elif shift < 86400:
            return "If a chronometer was present on the surface of your object, there will be a shift of {0} hours in one year between the latter and a distant observer".format(str(shift/3600))

        elif shift > 86400:
            return "If a chronometer was present on the surface of your object, there will be a shift of {0} days in one year between the latter and a distant observer".format(str(shift/3600))
